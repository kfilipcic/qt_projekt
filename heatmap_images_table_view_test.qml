        ...
        delegate: Image {
            ...
            MouseArea {
                ...
                onHoveredChanged: {
                    ...
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0]; 
    
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].sourceImagePath = imagePath;
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].usedModelForImagePath = modelPath;
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].predictedClassForImage = predictedClass;
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].predictedClassProbabilityForImage = classProbability;
    
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].sourceImageWidth = matrixImage.sourceSize.width;
                    resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].sourceImageHeight = matrixImage.sourceSize.height;
    
                    if (this.containsMouse) resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].visible = true;
                    else resultsPageObject.resultsPageObjectModelProp.children[0].children[1].children[0].visible = false;
                }
                Item {
                    id: imagePopupItem
                }
