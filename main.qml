                            ...
                            GridLayout {
                                ...
                                Button {
                                    ...
                                    onClicked: {
                                        ...
                                        //var heatmapImagesMatrixComponent = Qt.createComponent(qsTr("heatmap_images_matrix_tablemodel.qml"));
                                        //var heatmapImagesMatrixComponent = Qt.createComponent(qsTr("heatmap_images_matrix_tablemodel.qml"));
                                        ...
                                        resultsPageObjectModel.append(informationDockRectObject);

                                        var tableViewComponent = Qt.createComponent(qsTr("table_view.qml"));
                                        var tableViewObject = tableViewComponent.createObject();
                                        resultsPageObjectModel.insert(0, tableViewObject);

                                        console.log("resultsPageObjectModel.children.length: " + resultsPageObjectModel.children.length);

                                        swipeViewId.addItem(resultsPage);
